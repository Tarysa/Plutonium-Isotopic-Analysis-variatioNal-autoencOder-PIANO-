...
class VAE(nn.Module):
    ...
    def __init__(self, config, device, input_dim, input_class_dim=3, num_outputs=5):
        ...
        self.pu_regressor = Regressor(config, num_dense_layers= config.nb_dense_layer, use_physical_data=self.train_with_condition, 
                 input_class_dim=input_class_dim, num_classes=num_outputs)
    ...
    def forward(self, x, condition=None):
        ...
        preds_pu = self.pu_regressor(reg_input)
        ...
        if self.use_decoder:
            ...
            return (reconstruction, mu, log_sigma_2), preds_pu
        else:
            return None, preds_pu
    ...
    def exact_reconstruction(self, x, condition=None):
        ...
        normalized_preds_pu = self.pu_regressor(reg_input)
        ...
        if self.use_decoder:
            ...
            return reconstruction, mu, log_sigma_2, normalized_preds_pu
        else:
            return normalized_preds_pu
